...
const highlights = [
  {
    ...
    description: "7 anos em gestão e 2 anos em supervisão de TI municipal e outras atividades",
  },
  {
    icon: GraduationCap,
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-16">
          ...
          <div className="max-w-md space-y-6" data-aos="zoom-in-up" data-aos-delay="200">
            <p className="text-muted-foreground text-lg leading-relaxed font-sans">
              <span className="text-foreground font-semibold">Cientista de Dados e Gestor Estratégico</span> com 10 anos de experiência na administração pública.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed font-sans">
              Atualmente, atuo como Coordenador de Pós-Graduação no Instituto Federal do Maranhão (IFMA), consolidando uma trajetória de excelência na gestão educacional e tecnológica.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed font-sans">
              Minha carreira é marcada por uma transição estratégica da Universidade Estadual do Maranhão (UEMA) para a esfera Federal.
            </p>
          </div>
        </div>
