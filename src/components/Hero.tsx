        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8" data-aos="fade-right">
            ...
            <p className="text-muted-foreground text-lg max-w-xl leading-relaxed font-sans">
              ...
              Experiência em análise preditiva, visualização de dados e desenvolvimento de soluções.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button variant="outline" size="lg" asChild>
                <a href="/curriculo%20atualizado%20777.pdf" download="Curriculo_Duilio_Melo.pdf">
                  <Download size={18} />
                  Baixar CV
                </a>
              </Button>
